...
button_1 = tk.Button(frame, text="Files", padx=43, pady=10, fg="#1d1d1d", bg="#555555", activebackground="#555555", activeforeground="#1d1d1d", command=open_file)
button_1.grid(row=4, column=1, padx=10, pady=10)

button_2 = tk.Button(frame, text="Chrome", padx=34, pady=10, fg="#1d1d1d", bg="#555555", activebackground="#555555", activeforeground="#1d1d1d", command=open_chrome)
button_2.grid(row=5, column=1, padx=10, pady=10)

button_3 = tk.Button(frame, text="Settings", padx=34, pady=10, fg="#1d1d1d", bg="#555555", activebackground="#555555", activeforeground="#1d1d1d", command=open_settings)
button_3.grid(row=6, column=1, padx=10, pady=10)

button_4 = tk.Button(frame, text="Microsoft Store", padx=15, pady=10, fg="#1d1d1d", bg="#555555", activebackground="#555555", activeforeground="#1d1d1d", command=open_store)
button_4.grid(row=7, column=1, padx=10, pady=10)

button_5 = tk.Button(frame, text="VLC", padx=50, pady=10, fg="#1d1d1d", bg="#555555", activebackground="#555555", activeforeground="#1d1d1d", command=open_vlc)
button_5.grid(row=8, column=1, padx=10, pady=10)

button_6 = tk.Button(frame, text="Microsoft Excel", padx=18, pady=10, fg="#1d1d1d", bg="#555555", activebackground="#555555", activeforeground="#1d1d1d", command=open_excel)
button_6.grid(row=9, column=1, padx=10, pady=10)

# Right Side

button_7 = tk.Button(frame, text="Calendar", padx=34, pady=10, fg="#1d1d1d", bg="#555555", activebackground="#555555", activeforeground="#1d1d1d", command=open_calendar)
...
button_10 = tk.Button(frame, text="Task Manager", padx=20, pady=10, fg="#1d1d1d", bg="#555555", activebackground="#555555", activeforeground="#1d1d1d", command=open_taskmanager)
button_10.grid(row=7, column=5, padx=10, pady=10)

button_11 = tk.Button(frame, text="Photos", padx=44, pady=10, fg="#1d1d1d", bg="#555555", activebackground="#555555", activeforeground="#1d1d1d", command=open_photos)
button_11.grid(row=8, column=5, padx=10, pady=10)

button_12 = tk.Button(frame, text="CMD", padx=50, pady=10, fg="#1d1d1d", bg="#555555", activebackground="#555555", activeforeground="#1d1d1d",command=open_cmd)
